...
#    And In the Dashboad page I select the second option of the menu
#    Then in the first cluster of the job completed I make click in the checking button
#    And In the popup I make click in the checkin-out button
#    Then in the first cluster I make click in the button checkout
#    And In the popup I make click in the checkin-out button
